                                        ...
                                        <div className='bs-component'>
                                            <form>
                                                <fieldset>
                                                    ...
                                                    <br />
                                                    <br />
                                                    <button onClick={this.create} type="button" id="buttonSalvar" className="btn btn-success">
                                                        <i className="pi pi-save"></i> Salvar
                                                    </button>
                                                    <button onClick={this.cancel} type="button" id="buttonCancelar" className="btn btn-danger btn-cancel">
